            ...
            <div className="row">
              <div className="col-sm-8 text-left">
                  <h1 className="text-left">Contact</h1>
                    ...
                    <div className="App">
                        <div>
                          <form className="flex-left" ction="https://formspree.io/krittiyaclark@gmail.com" method="POST">
                            ...
                            <button type="submit" value="Send" id="button-submit" className="buttonfx slidebottomleft bouncein" required>Send</button>
                          </form>
                        </div>
                    </div>
              </div>
